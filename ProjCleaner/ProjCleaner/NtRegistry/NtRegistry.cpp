...
CString CNtRegistry::DisplayError(DWORD dwError)
{
	...
	if( lpMessageBuffer != NULL ) {
		...
		csReturn.Format(_T("Error( %u [0x%8XL] ) - %s"), dwError, dwError, csErrorMessage.Left(csErrorMessage.GetLength()-2));
	}
	else {
		csReturn.Format(_T("Error( %u [0x%8XL] ) - No NT Error Data was returned??"), dwError, dwError);
	}
...
//
//////////////////////////////////////////////////////////////////////
BOOL CNtRegistry::GetTextualSid(PSID pSid, LPTSTR szTextualSid, LPDWORD dwBufferLen) 
{
