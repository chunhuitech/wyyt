...
class CWyytSystrayDlg : public CDialog
{
// Construction
public:
	CWyytSystrayDlg(CWnd* pParent, CPoint pt, int iMaxUp, int iMaxDown, int iCurUp, int iCurDown);
	~CWyytSystrayDlg();
    
// Dialog Data
	//{{AFX_DATA(CWyytSystrayDlg)
	enum { IDD = IDD_WYYTTRAYDLG };
